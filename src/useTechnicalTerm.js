...
export const useTechnicalTerm = () => {
  const [technicalTerm, setTechnicalTerm] = useState([
    ...
    },
    {
      ...
      explanation:'随意運動・反射運動いずれの場合にもα運動ニューロン（→骨格筋）とγ運動ニューロン（→筋紡錘）の両方に上位中枢から信号が与えられ、α経路とγ経路が同時に働く関係のこと。伸び縮みする骨格筋に合わせて筋紡錘の長さを変化させることで、筋紡錘の感覚終末部が脱負荷の状態になったり、過伸張の状態になるのを防ぐ。',
    },
    {
      term:['興奮収縮連関',"E-C coupling","Excitation-Contraction coupling"],
      explanation:'細胞膜の興奮が骨格筋の収縮を引き起こす仕組み。T細管により活動電位が細胞内へ伝導→triadで隣接する筋小胞体のCa²⁺放出チャネルを開く→筋小胞体から筋形質中にCa²⁺が放出される→Ca²⁺がトロポニンに結合し収縮反応が引き起こされる→→Ca²⁺がトロポニンから除去されポンプで筋小胞体へCa²⁺が取り込まれることにより、筋形質のCa²⁺濃度が低下し弛緩する。',
    },
    // {
    //   term:[''],
    //   explanation:'',
